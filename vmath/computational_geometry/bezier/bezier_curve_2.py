from computational_geometry.bezier.bezier_point_2 import BezierPoint2
from computational_geometry import gutils
from computational_geometry.bounds.bounding_rect import BoundingRect
...
class BezierCurve2:
    ...
    def __next__(self) -> Vec2:
        ...
        return gutils.bezier_2_cubic(self.__iter_p1.point, self.__iter_p1.anchor_1,
    ...
    def __compute_and_update_sect_bbox(self, p1: BezierPoint2, p2: BezierPoint2):
        _min, _max = gutils.bezier_2_section_bounds(p1.point, p1.anchor_1, p2.anchor_2, p2.point)
    ...
    def curve_value(self, pid: int, t: float) -> Vec2:
        ...
        return gutils.bezier_2_cubic(p1.point, p1.anchor_1, p2.anchor_2, p2.point, t)
    ...
    def curve_tangent(self, pid: int, t: float) -> Vec2:
        ...
        p1: BezierPoint2 = self.__points[pid]
        p2: BezierPoint2 = self.__points[(pid + 1) % len(self.__points)]
        return gutils.bezier_2_tangent(p1.point, p1.anchor_1, p2.anchor_2, p2.point, t)
    ...
    def curve_normal(self, pid: int, t: float) -> Vec2:
        ...
        if t + dt <= 1:
            return gutils.perpendicular_2(
                gutils.bezier_2_cubic(p1.point, p1.anchor_1, p2.anchor_2, p2.point, t + dt) -
                gutils.bezier_2_cubic(p1.point, p1.anchor_1, p2.anchor_2, p2.point, t))
    ...
    def curve_values(self, step: float = 0.01):
        ...
        while True:
            ...
            yield gutils.bezier_2_cubic(p1.point, p1.anchor_1, p2.anchor_2, p2.point, t)
            t += step
    ...
    def curve_normals(self, step: float = 0.01):
        ...
        while True:
            if t >= 1.0:
                ...
                p1 = self.__points[point_id]
                p2 = self.__points[(point_id + 1) % len(self.__points)]
            yield gutils.perpendicular_2(
                gutils.bezier_2_cubic(p1.point, p1.anchor_1, p2.anchor_2, p2.point, t + step) -
                gutils.bezier_2_cubic(p1.point, p1.anchor_1, p2.anchor_2, p2.point, t))
            t += step
    ...
    def curve_tangents(self, step: float = 0.01):
        ...
        if self.closed:
            ...
            p2: BezierPoint2 = self.__points[0]
            while t >= 1.0:
                yield gutils.bezier_2_tangent(p1.point, p1.anchor_1, p2.anchor_2, p2.point, t)
                t += step
