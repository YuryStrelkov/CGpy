from computational_geometry.bezier.bezier_point_3 import BezierPoint3
from computational_geometry import gutils
from computational_geometry.vectors import Vec3
...
class BezierCurve3:
    ...
    def __next__(self) -> Vec3:
        ...
        return gutils.bezier_3_cubic(self.__iter_p1.point, self.__iter_p1.anchor_1,
    ...
    def curve_value(self, pid: int, t: float) -> Vec3:
        ...
        return gutils.bezier_3_cubic(p1.point, p1.anchor_1, p2.anchor_2, p2.point, t)
    ...
    def curve_normal(self, pid: int, t: float) -> Vec3:
        ...
        if t + dt <= 1:
            return gutils.perpendicular_3(
                gutils.bezier_3_cubic(p1.point, p1.anchor_1, p2.anchor_2, p2.point, t + dt) -
                gutils.bezier_3_cubic(p1.point, p1.anchor_1, p2.anchor_2, p2.point, t))
    ...
    def curve_tangent(self, pid: int, t: float) -> Vec3:
        ...
        p1: BezierPoint3 = self.__points[pid]
        p2: BezierPoint3 = self.__points[(pid + 1) % len(self.__points)]
        return gutils.bezier_3_tangent(p1.point, p1.anchor_1, p2.anchor_2, p2.point, t)
    ...
    def curve_values(self, step: float = 0.01):
        ...
        while True:
            ...
            yield gutils.bezier_3_tangent(p1.point, p1.anchor_1, p2.anchor_2, p2.point, t)
            t += step
    ...
    def curve_normals(self, step: float = 0.01):
        ...
        while True:
            ...
            yield gutils.perpendicular_2(
                gutils.bezier_3_tangent(p1.point, p1.anchor_1, p2.anchor_2, p2.point, t + step) -
                gutils.bezier_3_tangent(p1.point, p1.anchor_1, p2.anchor_2, p2.point, t))
            t += step
